  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-6 right-4 text-white text-xl z-30"
      >
        <FiX />
      </button>
      ...
      <div className="absolute bottom-4 left-4 right-4 z-30">
        ...
        <div className="flex items-center space-x-3 bg-black/70 rounded-xl px-4 py-3">
          ...
          <button
            ...
            className={`text-blue-400 text-base ${!newComment.trim() ? 'opacity-40' : 'opacity-100'}`}
          >
            Post
          </button>
        </div>
        ...
        {showComments && (
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b">
              ...
              <button onClick={() => setShowComments(false)} className="text-gray-600">
                <FiX />
              </button>
            </div>
                                  ...
                                  <div>
                                    <div className="flex justify-between">
                                      ...
                                      <button
                                        ...
                                        className={`text-xs ${r.isLiked ? 'text-red-500' : 'text-gray-400'}`}
                                      >
                                        {r.isLiked ? '♥' : '♡'} {r.likeCount}
                                      </button>
                                    </div>
                                    <p className="text-sm">{r.commentText}</p>
