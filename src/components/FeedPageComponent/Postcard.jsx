...
function Postcard({
  ...
  return (
    <>
      <div className={`w-full ${viewMode === 'grid' ? 'max-w-none rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-0 aspect-[9/19] flex flex-col' : 'max-w-[470px] sm:max-w-[320px] border-b border-gray-300 sm:mb-6 last:mb-0 snap-start h-[calc(100dvh-180px)] sm:h-auto sm:max-h-[700px] flex flex-col '} mx-auto bg-white transition-all duration-300`}>
        ...
        >
          {/* MEDIA WRAPPER: Relative, flex, centered */}          <div
            className="relative flex flex-col w-full h-full bg-black shadow-2xl overflow-hidden"
          >
            {/* 1. MEDIA PART */}
              ...
              <PostMedia
                ...
                footerSlot={
                  ...
                  isTemplate && hasFooter && (() => {
                    ...
                    return (
                      <div
                        className="relative w-full z-30 px-4 py-2 shrink-0 flex flex-col gap-1 border-t border-white/10"
                        style={{
                      ...
                      >
                        ...
                        <div
                          className={`flex items-center gap-2 ${showElements.userName && showElements.socialIcons && icons.length > 0
                            ? "justify-between"
                            : "justify-center"
                            }`}
                        >
