...
const ProfileStats = ({ 
  ...
  totalPost, 
  activeTab,
  activeStat, // Use this prop for highlighting
  friendsSectionView,
  onFollowersClick, 
  onFollowingClick,
  onPostsClick
    ...
    <div className="bg-white border-b border-gray-200 p-6 mb-6">
      <div className="flex justify-around gap-4">
        <div 
          ...
          className={`text-center flex-1 cursor-pointer transition-all duration-200 ${
            activeStat === 'posts' ? 'bg-blue-50 p-2 rounded-lg shadow-sm' : ''
          } hover:bg-gray-50 hover:rounded-lg hover:p-2`}
        >
        ...
        <div 
          ...
          className={`text-center flex-1 cursor-pointer transition-all duration-200 ${
            activeStat === 'followers' ? 'bg-blue-50 p-2 rounded-lg shadow-sm' : ''
          } hover:bg-gray-50 hover:rounded-lg hover:p-2`}
        >
        ...
        <div 
          ...
          className={`text-center flex-1 cursor-pointer transition-all duration-200 ${
            activeStat === 'following' ? 'bg-blue-50 p-2 rounded-lg shadow-sm' : ''
          } hover:bg-gray-50 hover:rounded-lg hover:p-2`}
        >
