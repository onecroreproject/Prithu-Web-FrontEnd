...
const FilterSection = ({
  ...
  // Calculate employment types from jobs
  ...
  // Calculate work modes from jobs
  ...
  // Calculate education levels from jobs - based on educationLevel field
  ...
  // Get countries from available filters or calculate from jobs
